...
/
prompt --application/shared_components/plugins/process_type/com_v1_simonj_azure_delete_blob
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(10782198925445992)
,p_plugin_type=>'PROCESS TYPE'
,p_name=>'COM.V1.SIMONJ.AZURE.DELETE_BLOB'
,p_display_name=>'Azure - Delete BLOB'
,p_supported_component_types=>'APEX_APPLICATION_PAGE_PROC:APEX_APPL_AUTOMATION_ACTIONS:APEX_APPL_TASKDEF_ACTIONS'
,p_default_escape_mode=>'HTML'
,p_api_version=>2
,p_execution_function=>'AZURE_API_PKG.delete_blob'
,p_substitute_attributes=>true
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10782414783446008)
,p_plugin_id=>wwv_flow_imp.id(10782198925445992)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(10782814968446009)
,p_plugin_id=>wwv_flow_imp.id(10782198925445992)
